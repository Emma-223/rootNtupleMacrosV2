...
void analysisClass::Loop()
{
  ...
  CreateUserHistWithSysts( "Pt3rdJet_PAS"                    ,    200   , 0       , 2000	  ); 
  ...
  CreateUserHistWithSysts( "Mee_PAS"		             ,    1000   , 0       , 2000	  ); 
  ...
  CreateUserHist2D( "MeeVsST_PAS"                 ,     400, 0, 4000, 400, 0, 4000) ;
  //CreateUserHist2D( "MeeVsST_PASandMee100"        ,     400, 0, 4000, 400, 0, 4000) ;
  CreateUserHist2D( "MeeVsPtee_PAS"                 ,     400, 0, 4000, 400, 0, 4000) ;
  ...
  CreateUserHistWithSysts( "Mee_EBEB_PAS"		   ,    1000 , 0       , 2000	 ); 
  CreateUserHistWithSysts( "Mee_EBEE_PAS"		   ,    1000 , 0       , 2000	 ); 
  CreateUserHistWithSysts( "Mee_EEEE_PAS"		   ,    1000 , 0       , 2000	 ); 
  CreateUserHistWithSysts( "Mee_EB_PAS" 		   ,    60 , 60       , 120	 ); 
  CreateUserHistWithSysts( "Mee_End2End2_PAS" 		   ,    60 , 60       , 120	 ); 
  ...
  if(do_roi_plots) {										     										 
    ...
    CreateUserHist2D( "MeeVsST_ROI"                 ,     400, 0, 4000, 400, 0, 4000) ;
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    double M_ej_avg_JES_Dn = 0, M_ej_min_JES_Dn = 0, M_ej_max_JES_Dn = 0, M_ej_asym_JES_Dn = 0;
    double M_ej_avg_EER_Up = 0, M_ej_min_EER_Up = 0, M_ej_max_EER_Up = 0, M_ej_asym_EER_Up = 0;
    double M_ej_avg_EER_Dn = 0, M_ej_min_EER_Dn = 0, M_ej_max_EER_Dn = 0, M_ej_asym_EER_Dn = 0;
    double M_ej_avg_EES_Up = 0, M_ej_min_EES_Up = 0, M_ej_max_EES_Up = 0, M_ej_asym_EES_Up = 0;
    ...
    if ( nEle_store >= 1 ) {
      ...
      fillVariableWithValue( "Ele1_Pt_skim",       Ele1_Pt, gen_weight * pileup_weight  ) ;
    ...
    if ( nJet_store >= 1 ) {
      ...
      fillVariableWithValue( "Jet1_Pt_skim", Jet1_Pt     , gen_weight * pileup_weight  ) ;
    ...
    if ( nJet_store >= 2 ) {
      ...
      fillVariableWithValue( "Jet2_Pt_skim", Jet2_Pt     , gen_weight * pileup_weight  ) ;
    ...
    if ( nEle_store >= 2 ) { 						    
      ...
      fillVariableWithValue( "M_e1e2_skim" , M_e1e2 , gen_weight * pileup_weight  ) ;
      ...
      fillVariableWithValue( "Pt_e1e2_skim", Pt_e1e2 , gen_weight * pileup_weight  ) ;

      fillVariableWithValue( "sT_eejj"      , sT_eejj , gen_weight * pileup_weight  ) ;
      fillVariableWithValue( "sT_eejj_skim" , sT_eejj , gen_weight * pileup_weight  ) ;
    ...
    // systematics
    // Masym
    fillSystVariableWithValue("EERUp",   "Masym",   isData() ? Masym : M_ej_asym_EER_Up);
    fillSystVariableWithValue("EERDown", "Masym",   isData() ? Masym : M_ej_asym_EER_Dn);
    fillSystVariableWithValue("EESUp",   "Masym",   isData() ? Masym : M_ej_asym_EES_Up);
    fillSystVariableWithValue("EESDown", "Masym",   isData() ? Masym : M_ej_asym_EES_Dn);
    fillSystVariableWithValue("JERUp",   "Masym",   isData() ? Masym : M_ej_asym_JER_Up);
    fillSystVariableWithValue("JERDown", "Masym",   isData() ? Masym : M_ej_asym_JER_Dn);
    fillSystVariableWithValue("JESUp",   "Masym",   isData() ? Masym : M_ej_asym_JES_Up);
    ...
    fillSystVariableWithValue("EESUp",   "MejMax",  isData() ? MejMax : M_ej_max_EES_Up);
    fillSystVariableWithValue("EESDown", "MejMax",  isData() ? MejMax : M_ej_max_EES_Dn);
    fillSystVariableWithValue("JERUp",   "MejMax",  isData() ? MejMax : M_ej_max_JER_Up);
    fillSystVariableWithValue("JERDown", "MejMax",  isData() ? MejMax : M_ej_max_JER_Dn);
    fillSystVariableWithValue("JESUp",   "MejMax",  isData() ? MejMax : M_ej_max_JES_Up);
    fillSystVariableWithValue("JESDown", "MejMax",  isData() ? MejMax : M_ej_max_JES_Dn);
    // MejMin
    fillSystVariableWithValue("EERUp",   "MejMin",  isData() ? MejMin : M_ej_min_EER_Up);
    fillSystVariableWithValue("EERDown", "MejMin",  isData() ? MejMin : M_ej_min_EER_Dn);
    fillSystVariableWithValue("EESUp",   "MejMin",  isData() ? MejMin : M_ej_min_EES_Up);
    fillSystVariableWithValue("EESDown", "MejMin",  isData() ? MejMin : M_ej_min_EES_Dn);
    fillSystVariableWithValue("JERUp",   "MejMin",  isData() ? MejMin : M_ej_min_JER_Up);
    fillSystVariableWithValue("JERDown", "MejMin",  isData() ? MejMin : M_ej_min_JER_Dn);
    fillSystVariableWithValue("JESUp",   "MejMin",  isData() ? MejMin : M_ej_min_JES_Up);
    fillSystVariableWithValue("JESDown", "MejMin",  isData() ? MejMin : M_ej_min_JES_Dn);
    ...
    const unsigned int NJETS = 5;
    double discArray[NJETS] = {Jet1_btagDisc, Jet2_btagDisc, Jet3_btagDisc, Jet4_btagDisc, Jet5_btagDisc};
    if(!isData())
    {
      float weightAtLeastTwoBJetsOneBtagBin = 0.0;
      // calculate and apply scale factors to MC only
      double sfArray[NJETS] = {Jet1_btagSF, Jet2_btagSF, Jet3_btagSF, Jet4_btagSF, Jet5_btagSF };
      for(unsigned int iJet = 0; iJet < NJETS; ++iJet) {
        if (discArray[iJet] > btagCut) {
          weightZeroBJets*=(1-sfArray[iJet]);
          float tmpWeight = 1.0;
          for(unsigned int jJet = 0; jJet < NJETS; ++jJet) {
    ...
    if(bkgControlRegion) {
      ...
      if(nBJet_ptCut>=1) {
        ...
        FillUserHist2D("MeeVsNJet_BkgControlRegion_gteOneBtaggedJet", nJet_ptCut, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsST_BkgControlRegion_gteOneBtaggedJet", sT_eejj, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsSTjet_BkgControlRegion_gteOneBtaggedJet", Jet1_Pt + Jet2_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsSTlep_BkgControlRegion_gteOneBtaggedJet", Ele1_Pt + Ele2_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsMejMin_BkgControlRegion_gteOneBtaggedJet", M_ej_min, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsMejMax_BkgControlRegion_gteOneBtaggedJet", M_ej_max, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsMeejj_BkgControlRegion_gteOneBtaggedJet", M_eejj, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsMe1j1_BkgControlRegion_gteOneBtaggedJet", M_e1j1, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsMe1j2_BkgControlRegion_gteOneBtaggedJet", M_e1j2, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsMe2j1_BkgControlRegion_gteOneBtaggedJet", M_e2j1, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsMe2j2_BkgControlRegion_gteOneBtaggedJet", M_e2j2, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsEle1Pt_BkgControlRegion_gteOneBtaggedJet", Ele1_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsEle2Pt_BkgControlRegion_gteOneBtaggedJet", Ele2_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsJet1Pt_BkgControlRegion_gteOneBtaggedJet", Jet1_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsJet2Pt_BkgControlRegion_gteOneBtaggedJet", Jet2_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsJet3Pt_BkgControlRegion_gteOneBtaggedJet", Jet3_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        FillUserHist2D("MeeVsPFMETType1Pt_BkgControlRegion_gteOneBtaggedJet", PFMET_Type1_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastOneBJet);
        if(nBJet_ptCut>=2) {
          FillUserHist( "Mee_BkgControlRegion_gteTwoBtaggedJets"      , M_e1e2,  pileup_weight * gen_weight * weightAtLeastTwoBJets, "preselection" ) ;
          FillUserHist2D("MeeVsNJet_BkgControlRegion_gteTwoBtaggedJets", nJet_ptCut, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsST_BkgControlRegion_gteTwoBtaggedJets", sT_eejj, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsSTjet_BkgControlRegion_gteTwoBtaggedJets", Jet1_Pt + Jet2_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsSTlep_BkgControlRegion_gteTwoBtaggedJets", Ele1_Pt + Ele2_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsMejMin_BkgControlRegion_gteTwoBtaggedJets", M_ej_min, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsMejMax_BkgControlRegion_gteTwoBtaggedJets", M_ej_max, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsMeejj_BkgControlRegion_gteTwoBtaggedJets", M_eejj, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsMe1j1_BkgControlRegion_gteTwoBtaggedJets", M_e1j1, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsMe1j2_BkgControlRegion_gteTwoBtaggedJets", M_e1j2, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsMe2j1_BkgControlRegion_gteTwoBtaggedJets", M_e2j1, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsMe2j2_BkgControlRegion_gteTwoBtaggedJets", M_e2j2, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsEle1Pt_BkgControlRegion_gteTwoBtaggedJets", Ele1_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsEle2Pt_BkgControlRegion_gteTwoBtaggedJets", Ele2_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsJet1Pt_BkgControlRegion_gteTwoBtaggedJets", Jet1_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsJet2Pt_BkgControlRegion_gteTwoBtaggedJets", Jet2_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsJet3Pt_BkgControlRegion_gteTwoBtaggedJets", Jet3_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
          FillUserHist2D("MeeVsPFMETType1Pt_BkgControlRegion_gteTwoBtaggedJets", PFMET_Type1_Pt, M_e1e2, pileup_weight * gen_weight * weightAtLeastTwoBJets);
        }
      }
      ...
      if      ( isEnd2End2 ) {
        FillUserHist( "Mee_End2End2_BkgControlRegion", M_e1e2, pileup_weight * gen_weight, "preselection" ); 
        //std::cout << "For electron1 with eta=" << Ele1_Eta << ", pT=" << Ele1_Pt << ", and electron2 with eta=" << Ele2_Eta << "pT=" << Ele2_Pt << ", we passed the end2end selection; applied event trigger scale factor = " << trigSF << std::endl;
      }
      // scale factor dependence histos
      FillUserHist2D("MeeVsNJet_BkgControlRegion", nJet_ptCut, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsST_BkgControlRegion", sT_eejj, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsSTjet_BkgControlRegion", Jet1_Pt + Jet2_Pt, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsSTlep_BkgControlRegion", Ele1_Pt + Ele2_Pt, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsMejMin_BkgControlRegion", M_ej_min, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsMejMax_BkgControlRegion", M_ej_max, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsMeejj_BkgControlRegion", M_eejj, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsMe1j1_BkgControlRegion", M_e1j1, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsMe1j2_BkgControlRegion", M_e1j2, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsMe2j1_BkgControlRegion", M_e2j1, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsMe2j2_BkgControlRegion", M_e2j2, M_e1e2, pileup_weight * gen_weight);
      FillUserHist2D("MeeVsEle1Pt_BkgControlRegion", Ele1_Pt, M_e1e2, pileup_weight * gen_weight);
    ...
    if ( passed_preselection ) {
      ...
      //  FillUserHist2D("PtEEVsZPtForOptBin600", Pt_e1e2, GenZGamma1_Pt, pileup_weight*gen_weight);
      //  //// printing
      //  //std::cout.precision(0);
      //  //std::cout << fixed <<  "Run = " << run << ", event = " << event << ", ls = " << ls << std::endl;
      //  //std::cout.precision(3);
      ...
      if ( fabs(M_e1j1-M_e2j2) < fabs(M_e1j2-M_e2j1) ) {
        ...
        FillUserHist2D("Me1jVsMe2j_selected" , M_e1j1  , M_e2j2, pileup_weight * gen_weight);
        FillUserHist2D("Me1jVsMe2j_rejected" , M_e1j2  , M_e2j1, pileup_weight * gen_weight);
      }
      else {
        ...
        FillUserHist2D("Me1jVsMe2j_selected" , M_e1j2  , M_e2j1, pileup_weight * gen_weight);
        FillUserHist2D("Me1jVsMe2j_rejected" , M_e1j1  , M_e2j2, pileup_weight * gen_weight);
      }
      ...
      if      ( isEnd2End2 ) FillUserHist( "Mee_End2End2_PAS", M_e1e2, pileup_weight * gen_weight, preselectionCut ); 
      ...
      if ( M_e1e2 > 100. ) { 
        ...
        //FillUserHist2D("MeeVsST_PASandMee100" , M_e1e2, sT_eejj, pileup_weight * gen_weight );	   
      ...
      if ( do_roi_plots && passed_region_of_interest ) { 
        ...
        FillUserHist2D("MeeVsST_ROI" , M_e1e2, sT_eejj, pileup_weight * gen_weight );	   
      ...
      if(doFinalSelections)
      {
        for (int i_lq_mass = 0; i_lq_mass < n_lq_mass; ++i_lq_mass ){ 
          ...
          sprintf(plot_name, "Mej_selected_min_vs_max_LQ%d", lq_mass ); FillUserHist2D ( plot_name, M_ej_min, M_ej_max, pileup_weight * gen_weight );
          ...
          sprintf(plot_name, "MeeVsST_LQ%d"           , lq_mass ); FillUserHist2D( plot_name , M_e1e2, sT_eejj                , pileup_weight * gen_weight );	   
